# -*- coding: utf-8 -*-
"""
Created on Wed Apr  1 11:23:34 2020
...
def find_Wa(X, C3, weights):
    res = 0
    y=0
    print("w:"+str(weights.shape[1]))
    print("x:"+str(X.shape[1]))
    for i in C3:
        if(weights.shape[1]==X.shape[1]):
            ...
            # print("y11:"+str(np.dot(XX,w1)))
            # print("y1:"+str(y1))
            # print("y2:"+str(y2))
            # print("distP1:"+str(distFromPlane1))
            # print("distP2:"+str(distFromPlane2))
            dis = (distFromPlane1 - distFromPlane2)
            print("dis(P1-P2):"+str(dis))
            res = min(res, dis)
    return -res+0.01
